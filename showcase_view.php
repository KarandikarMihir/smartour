...
<div id="content" style="background-color:#eff4ff;height:384px;width:100%;display:inline-block;padding-left:70px">
    <div class="pure-g">
        <div class="pure-u-1-2">
            <div style="height:340px;float:left;overflow:auto;">
                <table>
                    <tr>
                        <td colspan="2"><b>Contact Details</b></td>
                    </tr>
                    <tr>
                        <td style="width:40%">Name On Transaction</td>
                        <td><?php echo $NameOnTransaction; ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%">Concerned Person (Site)</td>
                        <td><?php echo $CPersonSite; ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%">Concerned Person (Office)</td>
                    ...
                    <tr>
                        <td>Larger Images</td>
                        <td><a href="gallery.php?KEY=<?php echo $KEY; ?>" target="_blank">Click Here</a></td>
                    </tr>
                </table>
            </div>            
        </div>
        <div class="pure-u-1-2">
            <div style="background:#FFFFFF;float:left;padding:5px;-webkit-box-shadow: 0 1px 3px rgba(0,0,0,.2);box-shadow: 0 1px 3px rgba(0,0,0,.2);">
                <div id="galleria">
                    <?php
