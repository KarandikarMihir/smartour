...
<div id="content" style="background-color:#eff4ff;height:384px;width:100%;display:inline-block;padding-left:70px">
    <div class="input-control text" style="width:30%;margin-left:3px;">
        <input type="text" name="searchparam" class="with-helper" autofocus onKeyUp="loadResults('resultset','custTourResults','request.php',this.value)" placeholder="Serial number or name of the customer" style="font-family: 'Segoe UI Light', 'Open Sans', Verdana, Arial, Helvetica, sans-serif;" required spellcheck="false" autocapitalize="off" autocorrect="off" autocomplete="off" /><a href="" OnClick=onclick="formSubmit()"><button class="btn-search"></button></a>
    </div>
    <p><i class="icon-new-tab"></i><a href="customer_new.php?mode=tour">Add new customer</a></p>
