...
<div id="content" style="background-color:#eff4ff;height:380px;width:100%;display:inline-block;padding-left:70px">
    <div style="float:left;width:95%;height:340px;overflow:auto;">
        <table  class="hovered" style="width:100%">
            ...
            {
                $result = mysql_query("SELECT srno, name, destination, mobile FROM enquiry WHERE srno=$SearchParam ORDER BY srno Asc;") or die(mysql_error());
            }
            else
            {
                $result = mysql_query("SELECT srno, name, destination, mobile FROM enquiry WHERE name LIKE '%$SearchParam%' ORDER BY srno Asc;") or die(mysql_error());
            } 
            ...
            else
            {
                ...
                echo '<tr><td style="width:50px;font-weight:bold;">No.</td><td style="width:200px;font-weight:bold;">Name</td><td style="width:150px;font-weight:bold;">Destination</td><td style="width:150px;font-weight:bold;">Mobile</td><td style="width:150px;font-weight:bold;">Action</td></tr>';
